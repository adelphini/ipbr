# *********************************************
# * ~/.bashrc Personalizado para GNU/Linux    *
# * System: Debian e seus Forks               *
# * local: /home/user/.bashrc                 *
# *                                           *
# * Author: Angelo Delphini                   *
# * E-Mail: angelo@delphini.com.br            *
# * Date: 2022-05-24                          *
# *********************************************
# ======================================================================
...
if [ $UID -eq "0" ]; then
  ...
  alias pbxget='sudo apt -y install'
  alias df='df -hT'
  alias ll='ls -alF'
  alias la='ls -A'
  alias l='ls -CF'
  alias ls='ls -la'
  alias pbxupdate='sudo apt update && apt -y upgrade && apt dist-upgrade'
  alias pbxreload='sudo reboot'
  alias pbxdelete='sudo apt autoclean && apt autoremove'
  alias pbxoff='sudo shutdown -h now'
  alias rm='rm -iv'
  alias cp='cp -aiv'
  alias mv='mv -iv'
  alias meuip='hostname -I'
  alias verip='ip -br a'
  alias admin='sudo su -'
  alias pbxstatus='sudo systemctl status asterisk.service'
  alias pbxdown='sudo systemctl stop asterisk.service'
  alias pbxoff='sudo shutdown -h now'
  alias pbxup='sudo systemctl start asterisk.service'
  alias pbx='rasterisk -vvvvgci'
